...
import type { NavigationLink, SiteSettings } from "@/types/site-settings";
...
export function HeaderClient({ siteSettings }: HeaderClientProps) {
  ...
  const siteTitle = siteSettings?.title || "AuraTechSolutions";
  const ctaText = siteSettings?.ctaButtonText || "Start Your Project";
  const ctaLink = siteSettings?.ctaButtonLink || "/contact";
